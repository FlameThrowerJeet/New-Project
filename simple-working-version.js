...
async function findPlusButton(page) {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    for (const button of buttons) {
      ...
      if (ariaLabel && (ariaLabel.includes('+') || ariaLabel.includes('Add'))) {
...
async function main() {
  console.log('🚀 Starting SIMPLE WORKING Meta AI Automation...');
